...
rule alphaRarefy:
    input:
        'flags-mg/divCore.done','mg-output/table-mg.qza','mg-output/rooted-tree.qza','mg_metadata.csv'
    output:
...
rule alphaGrpSig:
    input:
        'flags-mg/divCore.done','output/diversity-core/faith_pd_vector.qza','output/diversity-core/evenness_vector.qza','output/diversity-core/shannon_vector.qza','mg_metadata.csv'
    output:
        'flags-mg/alphaGrpSig.done','output/diversity-core/faith-pd-group-significance.qzv','output/diversity-core/evenness-group-significance.qzv','output/diversity-core/shannon-group-significance.qzv'
    shell:
        '''
...
rule betaGrpSig:
    input:
        'flags-mg/divCore.done','output/diversity-core/unweighted_unifrac_distance_matrix.qza','output/diversity-core/weighted_unifrac_distance_matrix.qza','output/diversity-core/bray_curtis_distance_matrix.qza','mg_metadata.csv'
    output:
        'flags-mg/betaGrpSig.done','output/diversity-core/unweighted-unifrac-mmb-significance.qzv','output/diversity-core/weighted-unifrac-mmb-significance.qzv','output/diversity-core/bray_curtis-mmb-significance.qzv'
    shell:
        '''
